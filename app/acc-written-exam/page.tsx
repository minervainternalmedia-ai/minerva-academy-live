    ...
    <main className="min-h-screen flex flex-col bg-minerva-white text-minerva-blue">
      ...
      <section className="w-full py-20 bg-gray-50 border-t border-gray-200">
        <div className="max-w-7xl mx-auto px-6">
          <div className="mb-12">
            <h2 className="text-3xl font-serif font-medium text-minerva-blue uppercase tracking-widest text-lg">Why Choose Minerva Academy For ACC Written Exam Coaching:</h2>
          </div>
      ...
      <section className="w-full py-20 bg-white">
        <div className="max-w-6xl mx-auto px-6 font-sans text-gray-700 font-light space-y-12">
      ...
      <section className="w-full py-20 bg-gray-50 border-t border-gray-200">
        <div className="max-w-5xl mx-auto px-6">
          <div className="mb-12">
            <h2 className="text-3xl font-serif font-medium text-minerva-blue">ACC Coaching Fees & Charges <span className="text-lg font-sans text-gray-500 tracking-normal lowercase">w.e.f. 1st January, 2022</span></h2>
          </div>
          ...
          <div className="bg-white shadow-xl border border-gray-200 overflow-hidden font-sans mb-8">
            ...
            <div className="divide-y divide-gray-200 text-sm">
              ...
              <div className="grid grid-cols-3 p-4 hover:bg-gray-50">
                ...
                <div className="font-medium text-minerva-primary">35500</div>
                <div></div>
              </div>
              <div className="grid grid-cols-3 p-4 hover:bg-gray-50">
          ...
          <div className="font-sans text-sm text-gray-700">
            <h4 className="font-bold text-minerva-blue mb-2 uppercase tracking-widest">Notes</h4>
      ...
      <section className="w-full py-24 bg-minerva-primary text-minerva-white relative overflow-hidden">
        ...
        <div className="relative z-10 max-w-4xl mx-auto px-6">
          <div className="text-center mb-12">
            ...
            <h2 className="text-3xl md:text-4xl font-serif font-medium">ACC Written Exam Coaching Application</h2>
          </div>
            ...
            <form className="space-y-6 font-sans">
              ...
              <div>
                ...
                <select className="w-full bg-minerva-primary border border-gray-700 px-4 py-3 text-white text-sm focus:outline-none focus:border-minerva-accent">
                  <option>ACC Written Exam Coaching (6 Weeks)</option>
                </select>
              </div>
